...
export default function Arcade({ onComplete, onBail }) {
  ...
  // (drawCatchReticles removed — landing reticle pointed at the gate
  // floor, but capture now happens on Tex's body anywhere on screen,
  // so the floor target was misleading. The icon's own glow is enough
